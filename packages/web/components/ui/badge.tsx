...
const badgeVariants = cva(
  "gap-1 border border-transparent font-medium transition-all [&>svg]:pointer-events-none focus-visible:border-ring focus-visible:ring-ring/50 focus-visible:ring-[3px] aria-invalid:ring-destructive/20 dark:aria-invalid:ring-destructive/40 aria-invalid:border-destructive overflow-hidden group/badge inline-flex items-center justify-center w-fit whitespace-nowrap shrink-0",
  {
    variants: {
      variant: {
